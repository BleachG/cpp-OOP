...
IMPLEMENT_DYNAMIC(opengl, CDialogEx)

opengl::opengl(CWnd* pParent /*=nullptr*/)
...
void opengl::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(opengl, CDialogEx)
//	ON_COMMAND(OPENGL, &opengl::OnOpengl)
END_MESSAGE_MAP()
